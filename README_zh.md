...
| **機器節點 / UUID** | 本地評測沙盒 | 單機本地 PC / Docker | 最高 3 組 Machine UUIDs (支援 Dev/Stage/Prod) | 多節點集群 (最多 15 節點) | 無限制集群與專屬硬體 |
| **同時併發 Agent 數量** | 2 角色 Demo | 單機自由運行 | 30 併發 (3 節點 × 10) / 30,000 高頻併發 | 450 併發 (15 節點 × 30) | 無上限百萬級 Agent 群蜂 (Swarm) |
