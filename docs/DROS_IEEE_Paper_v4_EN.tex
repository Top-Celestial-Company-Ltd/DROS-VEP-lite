...
\title{DROS: A Four-Layer Runtime Substrate with Deterministic Execution Enforcement for Agent-to-Execution Attribution Governance\thanks{Protected under U.S. Provisional Patent Application No. 64/111,973 (Patent Pending). Manuscript ID: SP-2026-08-0414 (Revision for Re-submission).}}
