...
\title{DROS: 針對自主 AI 工作負載中「Agent至執行歸因治理」的四層執行期作業基板與確定性執行強制機制 (v4.0)\thanks{專利聲明：DROS 執行治理與安全技術已申請美國臨時專利保護（U.S. Patent Application No. 64/111,973，Patent Pending）。永久學術文獻引用：Zenodo Record DOI: 10.5281/zenodo.21755653。}}
