"""Collect BASE-06 app-observed decision-latency samples on a warm AVD."""
...
# Make direct script execution resolve the canonical src package before the
# repository-level compatibility module named ``vep.py``.
...
def build_request(index: int) -> dict[str, object]:
    return {
        ...
        "revocation_epoch": 0,
        "arguments_hash": "sha256:android-base-06-args",
    }
    ...
    summary.update(
        {
            ...
            "reset_procedure": "app package cleared once by first controller submission; no reset between samples",
